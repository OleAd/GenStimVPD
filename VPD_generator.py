...
This should generate MIDI and Audio for Victor's PD experiment


HOW TO USE:
python VPD_generator.py BPM PARTICIPANTCODE

example:
python VPD_generator.py 120 OLEADRIAN

Audio and log files are generated in participants/PARTICIPANTID/

Experiment 1 is randomised order
Experiment 2 is controlled order
